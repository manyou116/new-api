# Frontend and Go compile on the build host (BUILDPLATFORM). Runtime image follows
# TARGETPLATFORM. With CGO disabled, multi-arch builds cross-compile without QEMU.
