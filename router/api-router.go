...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.GET("/task/self/image-studio/events", controller.StreamImageStudioTaskEvents)
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		apiRouter.GET("/exchange-rate", controller.GetExchangeRate)
		...
		apiRouter.GET("/subscription/public-plans", controller.GetPublicSubscriptionPlans)
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			userRoute.POST("/alipay/notify", controller.AlipayNativeNotify)
			userRoute.GET("/alipay/return", controller.AlipayNativeReturn)
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.POST("/alipay/pay", middleware.CriticalRateLimit(), controller.RequestAlipayNative)
			...
			adminRoute.Use(middleware.AdminAuth())
			{
				...
				adminRoute.GET("/summary", controller.GetUserSummary)
				adminRoute.GET("/dashboard/overview", controller.GetAdminDashboardOverview)
				adminRoute.GET("/dashboard/rankings", controller.GetAdminUserRankings)
				adminRoute.GET("/dashboard/today_stats", controller.GetAdminTodayStats)
				adminRoute.GET("/dashboard/usage_rankings", controller.GetAdminUserUsageRankings)
				adminRoute.GET("/dashboard/model_usage", controller.GetAdminModelUsageStats)
				adminRoute.GET("/topup", controller.GetAllTopUps)
				adminRoute.POST("/topup/complete", controller.AdminCompleteTopUp)
				adminRoute.GET("/search", controller.SearchUsers)
				adminRoute.GET("/:id/review", controller.GetUserReview)
				adminRoute.PUT("/:id/billing-preference", controller.UpdateUserBillingPreference)
				adminRoute.PUT("/:id/group", controller.UpdateUserGroup)
				adminRoute.GET("/:id/tokens", controller.GetAdminUserTokens)
				adminRoute.POST("/:id/tokens/:tokenId/key", controller.GetAdminUserTokenKey)
				adminRoute.PUT("/:id/tokens/:tokenId/group", controller.UpdateAdminUserTokenGroup)
		...
		subscriptionAdminRoute.Use(middleware.AdminAuth())
		{
			...
			subscriptionAdminRoute.POST("/user_subscriptions/:id/extend", controller.AdminExtendUserSubscription)
